        ...
        <div className="bg-[#1a472a] text-white px-8 py-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm opacity-90">Trail Module</div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            <div className="text-xs font-mono text-green-600 bg-green-50 px-2 py-1 rounded">
                              {record.Prod_Category || 'No Category'}
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setState(prev => ({ ...prev, Secondary_Email: e.target.value }))}
                />
              </div>
          ...
          <div className="border border-gray-300 rounded-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-3 pt-6 border-t">
                <h3 className="font-bold text-gray-700 mb-4">Payment Breakdown</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className={inputClass}
                      placeholder="0.00"
                      value={state.Bank_Amt || ''}
                      onChange={(e) => setState(prev => ({ ...prev, Bank_Amt: Number(e.target.value) }))}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className={inputClass}
                      placeholder="0.00"
                      value={state.Total_Cash_Received || ''}
                      onChange={(e) => setState(prev => ({ ...prev, Total_Cash_Received: Number(e.target.value) }))}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className={inputClass}
                      placeholder="0.00"
                      value={state.Other_Payment_mode_recd || ''}
                      onChange={(e) => setState(prev => ({ ...prev, Other_Payment_mode_recd: Number(e.target.value) }))}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className={inputClass}
                      placeholder="0.00"
                      value={state.Cheque_Amt || ''}
                      onChange={(e) => setState(prev => ({ ...prev, Cheque_Amt: Number(e.target.value) }))}
                    />
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-center justify-center">
                    <label className={checkboxLabelClass}>
                      <input 
                        ...
                        checked={state.Limit_Approved}
                        onChange={(e) => setState(prev => ({ ...prev, Limit_Approved: e.target.checked }))}
                      />
                      <span className="font-bold">Limit Approved</span>
                    </label>
                  </div>
                </div>
              </div>
          ...
          <div className="border border-gray-300 rounded-sm p-6">
            ...
            <label className={`${checkboxLabelClass} mb-6`}>
              ...
              />
              <span className="font-bold">Multi Product</span>
            </label>

            {/* Product 1 */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 p-4 bg-gray-50 rounded">
              <div>
                <label className={labelClass}>SKU 1</label>
                <input 
                  type="text" 
                  className={inputClass}
                  value={state.SKU1}
              ...
              <div>
                <label className={labelClass}>Model No. 1</label>
                <input 
                  type="text" 
                  className={inputClass}
              ...
              <div>
                <label className={labelClass}>Rate 1</label>
                <input 
                  type="number" 
                  className={inputClass}
                  placeholder="0.00"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border rounded">
                  <div>
                    ...
                    <input 
                      ...
                      className={inputClass}
                      value={state.SKU2}
                      onChange={(e) => setState(prev => ({ ...prev, SKU2: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      type="text" 
                      className={inputClass}
                      value={state.Model_No_2}
                      onChange={(e) => setState(prev => ({ ...prev, Model_No_2: e.target.value }))}
                    />
                  </div>
                  <div>
                    <label className={labelClass}>Serial No. 2</label>
                    <input 
                      type="text" 
                      className={inputClass}
                      value={state.Serial_Number_2}
                      onChange={(e) => setState(prev => ({ ...prev, Serial_Number_2: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="0.00"
                      value={state.Rate_2 || ''}
                      onChange={(e) => setState(prev => ({ ...prev, Rate_2: Number(e.target.value) }))}
                    />
                  </div>
                </div>

                {/* Add Products 3-5 similarly */}
              </div>
            )}
          ...
          <div className="border border-gray-300 rounded-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                {state.Redeemed && (
                  <div>
                    <label className={labelClass}>Redeemed Cashback Amount</label>
                    <input 
                      type="number" 
                      className={inputClass}
                      placeholder="0.00"
          ...
          {/* Section 7: Metadata & File Upload */}
          <div className="border border-gray-300 rounded-sm p-6">
            <h2 className={sectionHeaderClass}>
